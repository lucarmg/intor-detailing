...
const reasons = [
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="20" cy="16" r="1" fill="#c9a84c" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="rgba(201,168,76,0.15)" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="rgba(201,168,76,0.15)" />
        <circle cx="12" cy="9" r="2.5" fill="#c9a84c" stroke="none" />
      </svg>
    ),
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 700, color: "#fff", lineHeight: 1.15 }}>
              ...
              <span className="text-gold-gradient">Het is zorg voor uw auto.</span>
            </h2>
          </div>
        ...
        >
          {reasons.map((r) => (
            <div
              key={r.title}
              style={{ padding: 32, borderRadius: 18, background: "#111", border: "1px solid #1e1e1e", transition: "all 0.3s" }}
              onMouseEnter={(e) => {
            ...
            >
              <div style={{ display: "flex", alignItems: "flex-start", gap: 20 }}>
                ...
                <div>
                  <h3 style={{ fontFamily: "var(--font-playfair)", fontSize: 18, fontWeight: 600, color: "#fff", marginBottom: 8 }}>
                    {r.title}
                  </h3>
                  <p style={{ color: "#555", fontSize: 13, lineHeight: 1.7 }}>{r.desc}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: "radial-gradient(circle at 20% 50%, rgba(201,168,76,0.05) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(201,168,76,0.05) 0%, transparent 50%)",
            pointerEvents: "none",
          }} />
          <p style={{ color: "#666", fontSize: 11, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: 12 }}>
            Klaar voor een schoon interieur?
          </p>
          <h3 style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(24px, 3vw, 36px)", fontWeight: 700, color: "#fff", marginBottom: 28 }}>
          ...
          <a
            ...
            style={{
              ...
              padding: "16px 36px", background: "#c9a84c", color: "#000",
              borderRadius: 999, fontWeight: 700, fontSize: 15, textDecoration: "none",
              boxShadow: "0 0 32px rgba(201,168,76,0.25)", transition: "all 0.3s",
            }}
